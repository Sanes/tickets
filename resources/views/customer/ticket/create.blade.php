	...
	<div class="uk-grid-match uk-grid-small" uk-grid>
		...
		<div class="uk-width-1-3@l uk-visible@l">
			<div class="uk-padding-small" style="background: #f3f3f3;">
				<h4 class="uk-margin-small-top uk-margin-small-bottom">Ссылки</h4>
				Вы сможете добавить дополнительные материалы после отправки запроса.
				<h4 class="uk-margin-small-top uk-margin-small-bottom">Файлы</h4>
				Вы сможете добавить дополнительные материалы после отправки запроса.
